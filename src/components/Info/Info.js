      ...
      <div className="w3-third w3-hide-small">
        <div className="w3-white w3-text-grey w3-card-4 w3-margin-bottom w3-margin-left">
          ...
          <div className="w3-container">
            ...
            <hr />
            <p>
              <i className="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-light-green" />
              {t("info.current", { framework: "react-i18next" })}
            </p>
            <p>
              <i className="fa fa-home fa-fw w3-margin-right w3-large w3-text-light-green" />
              {t("info.place", { framework: "react-i18next" })}
            </p>
            <p>
              <i className="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-light-green" />
            ...
            <p>
              <i className="fa fa-phone fa-fw w3-margin-right w3-large w3-text-light-green" />
              +33642123867
            </p>
            <hr />
            <p className="w3-large w3-text-theme">
              <b>
                <i className="fa fa-globe fa-fw w3-margin-right w3-text-light-green" />
            ...
            <div className="w3-light-grey w3-round-xlarge">
              <div
                className="w3-round-xlarge w3-light-green"
                style={{ height: "24px", width: "100%" }}
              />
            </div>
            <br />
            <p>
              {t("info.languages.en", { framework: "react-i18next" })} (TOEIC
              Score : 965)
            </p>
            <div className="w3-light-grey w3-round-xlarge">
              <div
