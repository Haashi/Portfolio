...
class Exp extends Component {
  render() {
    ...
    let skillList = (
      <div className="row">
        {[
          <ul className="custom" key={0}>
            {list[0]}
          </ul>
        ]}
        {[
          <ul className="custom" key={1}>
            {list[1]}
          </ul>
        ]}
        {[
          <ul className="custom" key={2}>
            {list[2]}
          </ul>
        ]}
      </div>
      ...
      <div>
        <div className="w3-container row exp anim">
          <div className="col-2 w3-hide-small">
            ...
            >
              <img
                src={t("workexp." + this.props.id + ".iconurl", {
                  framework: "react-i18next"
                })}
                className="w3-rounded w3-image vertical-center"
                alt={t("workexp." + this.props.id + ".iconurl", {
                  framework: "react-i18next"
                })}
              />
            </a>
          ...
          <div className="col-9">
            ...
            {date}
            <p>
              {t("workexp." + this.props.id + ".description", {
                framework: "react-i18next"
              })}
            </p>
            {skillList}
