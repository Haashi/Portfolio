...
class Project extends Component {
  render() {
    ...
    const skillList =
      this.props.skillList !== undefined &&
      ...
      <div>
        <div className="jumbotron w3-center w3-twothird">
          ...
          <h1 className="display-4">
            {t("projects." + this.props.id + ".name", {
              framework: "react-i18next"
            })}
          </h1>
          <p className="lead">
            {t("projects." + this.props.id + ".description1", {
              framework: "react-i18next"
            })}
          </p>
          <br />
          ...
          <br />
          <p>
            {t("projects." + this.props.id + ".description2", {
              framework: "react-i18next"
            })}
          </p>
          <p>
            {t("projects." + this.props.id + ".description3", {
              framework: "react-i18next"
            })}
          </p>
        </div>
    ...
    return (
      <div
        className="w3-content w3-margin-top w3-margin-bottom"
